...
namespace Poseidon.BackOffice.Common.Actions
{
    public class SetFocusAction : TriggerAction<UIElement>
    {
        public static readonly DependencyProperty TargetProperty 
            = DependencyProperty.Register("Target", typeof(FrameworkElement), typeof(SetFocusAction), new FrameworkPropertyMetadata(null));
